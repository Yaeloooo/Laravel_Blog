<div class="text-blue-800 flex items-start sm:items-center p-4 mb-4 text-sm text-fg-brand-strong rounded-base bg-brand-softer" role="alert">
  ...
  <p><span class="font-medium me-1"> {{ $title }} </span> pene </p>
</div>
