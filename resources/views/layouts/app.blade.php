...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p class="text-sm leading-6">
                            Creando soluciones digitales increíbles desde 2026.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="email" placeholder="Email"
                                class="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm">
                            <button class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-500 transition text-sm">
                                Enviar
                            </button>
                        </div>
                    </div>
        ...
        {{-- ✅ @stack va AQUÍ, justo antes del </body>, FUERA del footer --}}
        @stack('scripts')

    </body>  {{-- ✅ body cierra DESPUÉS del @stack --}}
</html>
